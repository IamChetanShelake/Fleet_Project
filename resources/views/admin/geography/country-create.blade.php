...
<div class="dashboard-wrapper">
    ...
    <div class="geography-container">
        <div class="geography-header">
            <h1 class="geography-title">Create Country</h1>
        </div>
        ...
        <form class="geography-form" method="POST" action="{{ route('admin.countries.store') }}">
            @csrf
            ...
            <div class="form-grid">
                <div class="form-section">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" placeholder="e.g., Qatar" required>
                    </div>

                    <div class="form-group">
                        <label>Country Code <span class="required">*</span></label>
                        <input type="text" name="code" placeholder="e.g., QA" maxlength="10" required>
                    </div>
