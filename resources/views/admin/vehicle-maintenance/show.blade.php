            ...
            <div class="col-12">
                <div class="section-card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">Maintenance Record Details</h3>
                        <div>
                            <a href="{{ route('admin.vehicle-maintenance.edit', 1) }}" class="btn btn-warning">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="text-center">
                                    ...
                                    <h4 class="mb-2">Engine Service</h4>
                                    <p class="text-muted mb-3">TRK-001 - Volvo FH16</p>
                                    <div class="d-flex justify-content-center">
                                        <span class="badge bg-success me-2">Completed</span>
                                        <span class="badge bg-primary">$450.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        <div class="d-flex">
                                                            <i class="fas fa-user-hard-hat me-3 mt-1" style="width: 20px;"></i>
                                                            <div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="d-flex justify-content-center">
                                                            <div class="text-center">
                                                                ...
                                                                <p class="text-muted">Maintenance completed successfully</p>
                                                                <div class="progress mt-3">
                                                                    <div class="progress-bar bg-success" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                                                                </div>
                                                                <small class="text-muted mt-2">All tasks completed</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
