...
<div class="form-container-wrapper">
    ...
    <div class="form-container">
        ...
        <!-- Brand Form -->
        <form class="brand-form" method="POST" action="{{ route('admin.brands.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="name" placeholder="e.g., Toyota" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="slug" placeholder="e.g., toyota" value="{{ old('slug') }}">
                    @error('slug')
                        <span style="color: #ED5A68; font-size: 12px;">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" placeholder="Enter brand description">{{ old('description') }}</textarea>
                    @error('description')
                        <span style="color: #ED5A68; font-size: 12px;">{{ $message }}</span>
                    @enderror
                </div>
