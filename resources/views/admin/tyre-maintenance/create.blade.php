            ...
            <div class="col-12">
                <div class="section-card">
                    <div class="card-header">
                        <h3 class="mb-0">Add New Tyre Record</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.tyre-maintenance.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-custom">
                                        <i class="fas fa-save mr-2"></i> Save Tyre Record
                                    </button>
