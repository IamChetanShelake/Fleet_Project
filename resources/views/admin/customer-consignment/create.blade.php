...
<div class="consignment-container">
    ...
    <form class="consignment-form" method="POST" action="{{ route('admin.customer-consignment.store') }}">
        @csrf
        
        @if(!isset($selectedCustomerId) || !$selectedCustomerId)
        <!-- Customer Selection Dropdown -->
        <div style="background: white; border: 1px solid #6c6c6c; border-radius: 50px; padding: 24px 46px; max-width: 1035px; margin: 0 auto 25px;">
            <div class="form-group" style="margin-bottom: 0;">
                <label style="font-size: 18px; font-weight: 600; color: #317ff1; margin-bottom: 15px; display: block;">
                    <i class="fas fa-user"></i> Select Customer <span class="required">*</span>
                </label>
                <select name="customer_id_select" id="customer_id_select" onchange="selectCustomer(this.value)" style="width: 100%; height: 50px; border: 1px solid #b0b0b0; border-radius: 10px; padding: 0 17px; font-size: 16px;">
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="{{ route('admin.customer.create') }}" class="btn" style="background: #33C17F; color: white; padding: 12px 24px; border-radius: 10px; text-decoration: none; display: inline-block;">
        ...
        <div class="form-grid">
            <div class="form-section source-section">
                ...
                <div class="form-group">
                    ...
                    <div class="location-input-wrapper">
                        <div class="select-wrapper">
                            <input type="text" name="pickup_location" id="pickup_location" value="{{ old('pickup_location', isset($transport) ? $transport->pickup_location : '') }}" placeholder="Enter to Search on Map..">
                ...
                <div class="form-row">
                    <div class="form-group half">
                        ...
                        <input type="text" name="source_building_no" id="source_building_no" value="{{ old('source_building_no', isset($transport) ? $transport->source_building_no : '') }}" placeholder="Number..">
                    </div>
                    <div class="form-group half">
                        <label>Pincode</label>
                        <input type="text" name="source_pincode" id="source_pincode" value="{{ old('source_pincode', isset($transport) ? $transport->source_pincode : '') }}" placeholder="Code..">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group half">
                        <label>City</label>
                        <input type="text" name="source_city" id="source_city" value="{{ old('source_city', isset($transport) ? $transport->source_city : '') }}" placeholder="Enter City..">
                    </div>
                    <div class="form-group half">
                        <label>Area</label>
                        <input type="text" name="source_state" id="source_state" value="{{ old('source_state', isset($transport) ? $transport->source_state : '') }}" placeholder="Enter Area..">
                    </div>
                </div>

                <div class="form-group">
                    <label>Country</label>
                    <input type="text" name="source_country" id="source_country" value="{{ old('source_country', isset($transport) ? $transport->source_country : '') }}" placeholder="Enter Country..">
                </div>

                <div class="form-group">
                    <label>Google Maps Link</label>
                    <input type="url" name="source_maps_link" id="source_maps_link" value="{{ old('source_maps_link', isset($transport) ? $transport->source_maps_link : '') }}" placeholder="https://maps.google.com/...">
                </div>
            </div>
            ...
            <div class="form-section destination-section">
                ...
                <div class="form-group">
                    ...
                    <div class="location-input-wrapper">
                        <input type="text" name="delivery_location" id="delivery_location" value="{{ old('delivery_location', isset($transport) ? $transport->delivery_location : '') }}" placeholder="Enter Source Location (Type to Search on Map)">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address_line" id="address_line" value="{{ old('address_line', isset($transport) ? $transport->address_line : '') }}" placeholder="Street / Building or Location">
                </div>

                <div class="form-row">
                    <div class="form-group half">
                        <label>Building/House/Office No</label>
                        <input type="text" name="building_no" id="dest_building_no" value="{{ old('building_no', isset($transport) ? $transport->building_no : '') }}" placeholder="Number..">
                    </div>
                    <div class="form-group half">
                        <label>Pincode</label>
                        <input type="text" name="dest_pincode" id="dest_pincode" value="{{ old('dest_pincode', isset($transport) ? $transport->dest_pincode : '') }}" placeholder="Code..">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group half">
                        <label>City</label>
                        <input type="text" name="dest_city" id="dest_city" value="{{ old('dest_city', isset($transport) ? $transport->dest_city : '') }}" placeholder="Enter City..">
                    </div>
                    <div class="form-group half">
                        <label>Area</label>
                        <input type="text" name="dest_state" id="dest_state" value="{{ old('dest_state', isset($transport) ? $transport->dest_state : '') }}" placeholder="Enter Area..">
                    </div>
                </div>

                <div class="form-group">
                    <label>Country</label>
                        <input type="text" name="dest_country" id="dest_country" value="{{ old('dest_country', isset($transport) ? $transport->dest_country : '') }}" placeholder="Enter Country..">
                    </div>
                </div>

                <div class="form-group">
                    <label>Google Maps Link</label>
                    <input type="url" name="dest_maps_link" id="dest_maps_link" value="{{ old('dest_maps_link', isset($transport) ? $transport->dest_maps_link : '') }}" placeholder="https://maps.google.com/...">
                </div>
            </div>
        ...
        <div class="form-actions">
            <a href="{{ route('admin.customer-consignment.index') }}" class="btn btn-secondary">Back</a>
...
function confirmLocation() {
    ...
    if (selectedLocationType === 'pickup') {
        ...
        if (destCity && components.city) {
            destCity.value = components.city;
        }
...
function selectCustomer(customerId) {
    ...
    let customerInput = document.querySelector('input[name="customer_id"]');
    if (!customerInput) {
        customerInput = document.createElement('input');
        customerInput.type = 'hidden';
        customerInput.name = 'customer_id';
        document.querySelector('.consignment-form').appendChild(customerInput);
    }
    customerInput.value = customerId;
    
    // Store customer_id in sessionStorage for persistence
    sessionStorage.setItem('selected_customer_id', customerId);
    
    // Show confirmation
    alert('Customer selected! You can now fill in the consignment details.');
}
</script>
